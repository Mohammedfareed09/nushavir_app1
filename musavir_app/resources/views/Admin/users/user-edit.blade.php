...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" class="app-default">
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header cursor-pointer">
            ...
            <!--end::Card title-->
            <!--begin::Action-->
            <a href="{{ route('admin.users.index') }}" class="btn btn-sm btn-primary align-self-center">Back to Users</a>
            <!--end::Action-->
        </div>
        <!--end::Card header-->
        ...
        <div class="card-body p-9">
            <!--begin::Form-->
            <form id="kt_account_profile_details_form" method="POST" action="{{ route('admin.users.update', $user->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        <!-- Avatar Display -->
                        <div class="mb-3 avatar-display">
                            <img id="avatarDisplay" src="{{ $user->avatar_path ? asset('storage/' . $user->avatar_path) : asset('assets/media/avatars/300-1.jpg') }}" alt="Avatar" />
                        </div>
                        <!-- File Upload -->
                        <div class="mb-3">
