...
<body id="kt_body" class="app-blank">
    ...
    <div class="center-container">
        <!--begin::Authentication - Phone Verification -->
        <div class="form-wrapper">
            <!--begin::Form-->
            <div class="text-center mb-11">
                <!--begin::Title-->
                <h1 class="text-gray-900 fw-bolder mb-3">Phone Number Verification</h1>
                <!--end::Title-->
                <div class="mb-4 text-sm text-gray-600">
                    {{ __('Enter Your Phone Number') }}
                </div>
            </div>
            <form class="form w-100" method="POST" action="{{ route('phone.verify') }}">
                @csrf
        ...
        <!--end::Authentication - Phone Verification-->
    </div>
    <!--end::Root-->
    <!--begin::Javascript-->
    <script>
